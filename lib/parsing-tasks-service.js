    ...
    async createTask(userId, taskData) {
        ...
        try {
            console.log('📝 ParsingTasksService.createTask called with:', {
                ...
                resultsPerQuery: taskData.resultsPerQuery || 50,  // User-requested count
            ...
            const task = {
                ...
                category_id: taskData.categoryId || null,    // Category ID for filtering/grouping
                status: 'pending',
                ...
                // 🔧 FIX: Save task_data JSONB with user configuration
                task_data: {
                    taskName: taskData.taskName,
                    searchQuery: taskData.searchQuery,
                    categoryId: taskData.categoryId,
