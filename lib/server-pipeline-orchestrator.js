...
class ServerPipelineOrchestrator {
    ...
    async executeSearch(taskId) {
        ...
        try {
            ...
            const { task_name: taskName, search_query: searchQuery, website_url: websiteUrl, task_type: taskType, task_data } = task;
            ...
            // Get resultsPerQuery from task_data, with fallback to default
