...
class BackgroundWorker {
    constructor(options = {}) {
        ...
        this.runningTasks = new Map(); // taskId -> { promise, orchestrator }
        this.pollTimer = null;
    ...
    async processTask(task) {
        ...
        // Create dedicated orchestrator instance for this task
        ...
        try {
            ...
            // Execute the pipeline with dedicated orchestrator instance
